    ...
    <td className="px-3 py-3.5 align-middle">
      <div className="flex items-center gap-2.5">
        ...
        <span className="flex items-center gap-2 font-medium text-ink">
          {name}
          {isStarred && (
            <svg aria-hidden="true" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 text-amber-400">
